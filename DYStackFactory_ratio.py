...
#include <cstdlib>
 ...
 TString DirPreName = "PlotsElectron_50ns_Total_";
...
TString filenamepath("/afs/hep.wisc.edu/cms/khurana/Script/Electron_50ns_15102015/");
...
// TTJets 5
filenameString.push_back(filenamepath + "Merged_TT_TuneCUETP8M1_13TeV-pythia8-runallAnalysis.root");
...
//Data File
// 50 ns dataset B
//filenameString.push_back(filenamepath + "Merged_SingleElectron_Run2015B-PromptReco-v1_50ns-runallAnalysis.root");

// 50 ns dataset C
//filenameString.push_back(filenamepath + "Merged_SingleElectron_Run2015C-PromptReco-v1_50ns-runallAnalysis.root");

filenameString.push_back(filenamepath + "Data_50ns.root");
...
for(int i =0; i<(int)filenameString.size()-1; i++){
 ...
 h_total              = (TH1F*) fIn->Get("nEvents_weight");                                                                                     normalization[i]     = (lumi* Xsec[i])/(h_total->Integral());
 if(!VARIABLEBINS){
 ...
 h_rebin[i]->Sumw2();
 h_rebin[i]->Rebin(45,"h_mc[i]",massbin);
 }
...
h_data_rebin->Sumw2();
h_data_rebin->Rebin(45,"h_data",massbin);
}
if(!VARIABLEBINS){
...
TLatex *t2a;
if(NORATIOPLOT){
 t2a = new TLatex(0.5,0.97,latexname);
 t2a->SetTextSize(0.04);
 }else{
 t2a = new TLatex(0.5,0.98,latexname);
...
makeplot(['Charge',  'h_InvMass', 'M_{ee}', '0', '3000',  '1', '1' , '0', 'fullrangelogvariableBin','0','1'])
...
#####
####
####(['DiElectronMediumIDIso', 'h_InvMass', 'M_{ee}', '0', '400', '6', '1', '1', 'fullrange' ])
####(['DiElectronMediumIDIso',  'h_InvMass', 'M_{ee}', '60', '120', '3', '1' ,'1'])
####(['DiElectronMediumIDIso',   'h_pt', 'p_{T}^{ee} ', '0 ', '300' , '8', '1' ])
####(['DiElectronMediumIDIso',   'h_eta', '#eta_{ee} ', '-5.', '5' , '2', '1' ])
####(['DiElectronMediumIDIso',   'h_energy','energy_{ee}','0','800','1','1'])
####(['DiElectronMediumIDIso',   'h_phi', '#phi_{ee} ', '-3.5', '3.5' , '1', '1' ])
####(['DiElectronMediumIDIso',   'h_DeltaR', '#Delta#R{ee} ', '0', '5' , '1', '1' ])
####(['DiElectronMediumIDIso',   'h_DeltaPhi', '#Delta#phi{ee} ', '-3.5', '3.5' , '2', '1' ])
####(['DiElectronMediumIDIso',   'h_DeltaEta', '#Delta#eta{ee} ', '-5', '5' , '1', '1' ])
####(['DiElectronMediumIDIso',   'h_Pt2OverPt1', 'p_{T}^{e1}/p_{T}^{e2} ', '0', '1' , '1', '1' ])
####(['DiElectronMediumIDIso',   'h_PtOverPt1Pt2', 'p_{T}^{ee}/p_{T}^{e1}+p_{T}^{e2} ', '0', '1' , '1', '1' ])
####
