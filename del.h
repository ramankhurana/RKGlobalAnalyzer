...
// Mon Feb  1 05:41:19 2016 by ROOT version 6.02/05
// from TTree treeMaker/tree
// found on file: Merged_MonoHTobb_M1400GeV.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("Merged_MonoHTobb_M1400GeV.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("Merged_MonoHTobb_M1400GeV.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("Merged_MonoHTobb_M1400GeV.root:/tree");
