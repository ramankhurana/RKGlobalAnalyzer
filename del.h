...
// Thu Nov 26 16:04:33 2015 by ROOT version 6.02/05
// from TTree treeMaker/tree
// found on file: /hdfs/store/user/khurana/DYJetsToLL_M-10to50_TuneCUETP8M1_13TeV-amcatnloFXFX-pythia8/crab_DYJetsToLL_M-10to50_TuneCUETP8M1_13TeV-amcatnloFXFX-pythia8_MC25ns_ReMiniAOD_NewMiniIso_Extended/151124_182452/0000/NCUGlobalTuples_168.root
//////////////////////////////////////////////////////////
...
#ifdef del_cxx
del::del(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/hdfs/store/user/khurana/DYJetsToLL_M-10to50_TuneCUETP8M1_13TeV-amcatnloFXFX-pythia8/crab_DYJetsToLL_M-10to50_TuneCUETP8M1_13TeV-amcatnloFXFX-pythia8_MC25ns_ReMiniAOD_NewMiniIso_Extended/151124_182452/0000/NCUGlobalTuples_168.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/hdfs/store/user/khurana/DYJetsToLL_M-10to50_TuneCUETP8M1_13TeV-amcatnloFXFX-pythia8/crab_DYJetsToLL_M-10to50_TuneCUETP8M1_13TeV-amcatnloFXFX-pythia8_MC25ns_ReMiniAOD_NewMiniIso_Extended/151124_182452/0000/NCUGlobalTuples_168.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("/hdfs/store/user/khurana/DYJetsToLL_M-10to50_TuneCUETP8M1_13TeV-amcatnloFXFX-pythia8/crab_DYJetsToLL_M-10to50_TuneCUETP8M1_13TeV-amcatnloFXFX-pythia8_MC25ns_ReMiniAOD_NewMiniIso_Extended/151124_182452/0000/NCUGlobalTuples_168.root:/tree");
...
Int_t del::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t del::LoadTree(Long64_t entry)
{
