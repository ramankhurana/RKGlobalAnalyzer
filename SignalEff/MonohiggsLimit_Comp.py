...
#                    histList[ii].Scale(histList[0].Integral()/histList[ii].Integral())
    ...
    for ih in range(len(histList)):
        histList[ih].SetMaximum(0.5) #1.4 for log
...
files=['Results_Venice/MonoHFatJetsPreselection_2subj8112015Integral.root','Results_Venice/MonoHFatJetSelection_LeptonVeto8112015Integral.root','Results_Venice/MonoHFatJetSelection_Jetveto8112015Integral.root','Results_Venice/MonoHFatJetSelection_JetAndLeptonVeto8112015Integral.root']
ytitle='limit'
histnames=['LimitExpectedCLs']
legend1=['Preselection','JetVeto','LeptonVeto','Jet & LeptonVeto']
DrawOverlap(files,histnames,['M_{Z`}',ytitle],legend1,'ExpLimit_20151108_')
