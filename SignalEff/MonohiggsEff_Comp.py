...
def DrawOverlap(fileVec, histVec, titleVec,legendtext,pngname, xRange=[-99999,99999,1]):
    ...
    ## Legend
    leg = TLegend(0.14, 0.780, 0.85, 0.89)#,NULL,"brNDC");
    leg.SetNColumns(2);
    leg.SetBorderSize(0)
    leg.SetLineColor(1)
    leg.SetLineStyle(1)
...
#                    histList[ii].Scale(histList[0].Integral()/histList[ii].Integral())
    ...
    for ih in range(len(histList)):
        histList[ih].SetMaximum(0.9) #1.4 for log
...
#        histList[ih].Draw("same")
    ...
    text = pt.AddText(0.8,0.5,"#sqrt{s} = 13 TeV ")
    pt.Draw()
    leg.Draw()
...
files=['SignalEff_Graph_20151108.root']
ytitle='Efficiency'
histnames=['MonoHFatJetsPreselection','MonoHFatJetsPreselection_2subj','MonoHFatJetsPreselection_1subj','MonoHFatJetsPreselection_DRsubj','MonoHFatJetsPreselection_DROnesubj','Subjet1PlusSubjet2']
legend =['Fatjet','2subj','1subj','DRsubj','DR1subj','1+2']
DrawOverlap(files,histnames,['M_{Z`}',ytitle],legend,'SignalEff_20151108')
histnames1=['MonoHFatJetsPreselection_2subj','MonoHFatJetSelection_Jetveto','MonoHFatJetSelection_LeptonVeto','MonoHFatJetSelection_JetAndLeptonVeto']
legend1=['Preselection','JetVeto','LeptonVeto','Jet & LeptonVeto']
DrawOverlap(files,histnames1,['M_{Z`}',ytitle],legend1,'SignalEff_20151108_1')
