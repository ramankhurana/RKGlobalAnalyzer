...
TString filenamepathdata("/home/monika/Downloads/");
//Change here Directories of the file
//TString filenamepath("/home/monika/Desktop/Work/After_Phd/DY201508017_DY/");
TString filenamepath("/home/monika/Desktop/Work/After_Phd/DY201508026_DoubleElectron/");
//TString filenamepathdata("/home/monika/Desktop/Work/After_Phd/DY201508015_4/");
//Signal 0
...
//DYJets Low 7
filenameString.push_back(filenamepath + "Merged_DYJetsToLL_M-10to50_TuneCUETP8M1_13TeV-amcatnloFXFX-pythia8-runallAnalysis.root");

//Data File
//filenameString.push_back("../Ridhi_Singleele.root");
filenameString.push_back("../Merged_DoubleEG_Run2015B-PromptReco-v1_31082015_DoubleTrigg_New-runallAnalysis.root");
//filenameString.push_back("../Merged_DoubleEG_Run2015B-PromptReco-v1_31082015_DoubleTrigg_No_Triggerchanged-runallAnalysis.root");

//filenameString.push_back("../Merged_DoubleEG_Run2015B-PromptReco-v1_31082015_DoubleTrigg-runallAnalysis.root");



//filenameString.push_back("../Merged_DoubleEG_Run2015B-PromptReco-v1_31082015-runallAnalysis.root");
//filenameString.push_back("../Merged_SingleElectron_Run2015B-TwoRuns_74_diff_RLE-runallAnalysis.root");
//filenameString.push_back(filenamepath + "Merged_DoubleEG_Run2015B-PromptReco-v1_0819_JSONV2_Full40-runallAnalysis.root");
//filenameString.push_back(filenamepath + "Merged_SingleElectron_Run2015B-PromptReco-Full40-runallAnalysis.root");
//filenameString.push_back(filenamepathdata + "Merged_SingleElectron_Run2015B-PromptReco-Full40_TM-runallAnalysis.root");
//filenameString.push_back(filenamepathdata + "Merged_SingleElectron_Run2015B-PromptReco-Full7-runallAnalysis.root");
//histoname
...
// Int_t binxmax = xaxis->FindBin(XMAX);
 ...
 Int_t binxmax = XMAX;
  ...
  float qcdEntries =0.0, dibosonentries =0.0, totalbkg = 0, ratioSB = 0;
  /*for(int qcd = 6; qcd < 22 ; qcd++){                                                                                   
    qcdEntries+ = h_mc[qcd]->GetBinContent(binxmax);}*/

  for(int diboson = 2; diboson < 5; diboson++){                                                                                                  dibosonentries+ = h_mc[diboson]->GetBinContent(binxmax);}                                                    
  
  totalbkg = dibosonentries +h_mc[5]->GetBinContent(binxmax)+h_mc[1]->GetBinContent(binxmax)+ h_mc[0]->GetBinContent(binxmax)+h_mc[7]->GetBinContent(binxmax); 

 ratioSB = (h_mc[0]->GetBinContent(binxmax)+h_mc[7]->GetBinContent(binxmax))/totalbkg;

                                     
  mout <<"HISTPATH_HISTNAME"            << "   &   " 
  //<< setprecision(0)
  << (int)h_data->GetBinContent(binxmax)  << "   &   " 
  << (int)h_mc[0]->GetBinContent(binxmax)+(int)h_mc[7]->GetBinContent(binxmax) << "   &   " 
  << (int)dibosonentries                     << "   &   "
  << (int)h_mc[5]->GetBinContent(binxmax) << "   &   " 
  << (int)h_mc[1]->GetBinContent(binxmax) << "   &   "
//  << (int)h_mc[7]->GetBinContent(binxmax) << "   &   "
  << (int)totalbkg                           << "   \\   "
 // << setprecision(2)
//  << ratioSB                            << "   //  "
  <<std::endl;
