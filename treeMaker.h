...
// Mon Jul 27 04:19:16 2015 by ROOT version 6.02/05
// from TTree treeMaker/tree
// found on file: /hdfs/store/user/khurana/DoubleEG/crab_DoubleEG_Run2015B-PromptReco-v1_JSON_50p0pbInv/150721_213147/0000/NCUGlobalTuples_231.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   vector<float>   *disc_byCombinedIsolationDeltaBetaCorrRaw3Hits;
   ...
   TBranch        *b_disc_byCombinedIsolationDeltaBetaCorrRaw3Hits;   //!
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/hdfs/store/user/khurana/DoubleEG/crab_DoubleEG_Run2015B-PromptReco-v1_JSON_50p0pbInv/150721_213147/0000/NCUGlobalTuples_231.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/hdfs/store/user/khurana/DoubleEG/crab_DoubleEG_Run2015B-PromptReco-v1_JSON_50p0pbInv/150721_213147/0000/NCUGlobalTuples_231.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("/hdfs/store/user/khurana/DoubleEG/crab_DoubleEG_Run2015B-PromptReco-v1_JSON_50p0pbInv/150721_213147/0000/NCUGlobalTuples_231.root:/tree");
...
void treeMaker::Init(TTree *tree)
{
   ...
   disc_byCombinedIsolationDeltaBetaCorrRaw3Hits = 0;
   ...
   fChain->SetBranchAddress("disc_byCombinedIsolationDeltaBetaCorrRaw3Hits", &disc_byCombinedIsolationDeltaBetaCorrRaw3Hits, &b_disc_byCombinedIsolationDeltaBetaCorrRaw3Hits);
