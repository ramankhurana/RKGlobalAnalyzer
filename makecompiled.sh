...
g++ `root-config --cflags` RKAnalysisController/src/Main.C RKAnalyzer.o JetValidator.o METValidator.o SelectionBitsProducer.o CutFlowAndEachCut.o NMinusOne.o HistFactory.o -o main.exe `root-config --libs`
