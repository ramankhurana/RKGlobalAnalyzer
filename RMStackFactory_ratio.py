...
float lumi = 831.02; // It will print on your plots too

std::vector<TString> filenameString;
//Change here Directories of the file
TString filenamepath("MonoHFatJetAnalysis_AllMCWithPU_V10/");
...
filenameString.push_back(filenamepath + "Merged_WJetsToLNu_HT-600ToInf_TuneCUETP8M1_13TeV-madgraphMLM-pythia8-runallAnalysis.root");
filenameString.push_back(filenamepath + "Merged_WJetsToLNu_HT-600ToInf_TuneCUETP8M1_13TeV-madgraphMLM-pythia8-runallAnalysis.root");
filenameString.push_back(filenamepath + "Merged_WJetsToLNu_HT-600ToInf_TuneCUETP8M1_13TeV-madgraphMLM-pythia8-runallAnalysis.root");
filenameString.push_back(filenamepath + "Merged_WJetsToLNu_HT-600ToInf_TuneCUETP8M1_13TeV-madgraphMLM-pythia8-runallAnalysis.root");
filenameString.push_back(filenamepath + "Merged_WJetsToLNu_HT-600ToInf_TuneCUETP8M1_13TeV-madgraphMLM-pythia8-runallAnalysis.root");
...
Xsec[19] = 1347;  // WJets HT 100-200
Xsec[20] = 360;   // WJets HT 200-400
Xsec[21] = 18.77;  // WJets HT 600-Inf
Xsec[22] = 18.77;  // WJets HT 600-Inf
Xsec[23] = 18.77;  // WJets HT 600-Inf
Xsec[24] = 18.77;  // WJets HT 600-Inf
Xsec[25] = 18.77;  // WJets HT 600-Inf
...
//    qcdEntries+ = h_mc[qcd]->GetBinContent(5);}
  ...
  mout << " DY high pt"<<h_mc[15]->GetBinContent(5)+h_mc[16]->GetBinContent(5)+h_mc[17]->GetBinContent(5)+h_mc[18]->GetBinContent(5) << std::endl;  
  mout << " M600 "    << h_mc[8]->GetBinContent(5) << std::endl;
  mout << " M700 "    << h_mc[9]->GetBinContent(5) << std::endl;
  mout << " M800 "    << h_mc[10]->GetBinContent(5) << std::endl;
  mout << " M900 "    << h_mc[11]->GetBinContent(5) << std::endl;
  mout << " M1000 "   << h_mc[12]->GetBinContent(5) << std::endl;
  mout << " M1200 "   << h_mc[13]->GetBinContent(5) << std::endl;
  mout << " M1500 "   << h_mc[14]->GetBinContent(5) << std::endl;
...
#    makeplot([dirname,'h_MET0','MET','200','600','2','0'])
#    makeplot([dirname,'h_Mjj0','M_{SD}','60','200','1','0','1']) 
#    makeplot([dirname,'h_pTjj0','p_{T}^{AK8Jet}','100','600','2','0'])
