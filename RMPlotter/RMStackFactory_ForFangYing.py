...
TString filenamepath("/afs/cern.ch/user/f/fatsai/public/'''+inputdirname+'''/"); 
// DYJets 1
...
#dirnames=['histfacFatJet_WLight','histfacFatJet_TTBar','histfacFatJet_ZLight','histfacFatJet_TTBar_Merged','histfacFatJet_WHeavy']
