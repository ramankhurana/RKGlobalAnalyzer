...
#                    histList[ii].Scale(histList[0].Integral()/histList[ii].Integral())
    ...
    for ih in range(len(histList)):
        histList[ih].SetMaximum(4) #1.4 for log
...
files=['/afs/hep.wisc.edu/cms/khurana/DMRunII/CMSSW_7_4_7_patch1/src/RootFiles/fatjet.root','/afs/hep.wisc.edu/cms/khurana/DMRunII/CMSSW_7_4_7_patch1/src/RootFiles/twosubjets.root', '/afs/hep.wisc.edu/cms/khurana/DMRunII/CMSSW_7_4_7_patch1/src/RootFiles/onesubjet.root', '/afs/hep.wisc.edu/cms/khurana/DMRunII/CMSSW_7_4_7_patch1/src/RootFiles/drsubjets.root', '/afs/hep.wisc.edu/cms/khurana/DMRunII/CMSSW_7_4_7_patch1/src/RootFiles/oneplustwo.root' ]
...
##ytitle='# of Events'
ytitle='#sigma_{Z`#rightarrowA_{0}H#rightarrow 2DM bb}'
