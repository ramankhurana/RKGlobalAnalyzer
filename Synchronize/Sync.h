...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   vector<float>   *FATjetPassIDLoose;
   vector<float>   *FATjetPassIDTight;
   vector<float>   *FATPUJetID;
   vector<float>   *FATisPUJetID;
   ...
   vector<float>   *THINjetPassIDLoose;
   vector<float>   *THINjetPassIDTight;
   vector<float>   *THINPUJetID;
   vector<float>   *THINisPUJetID;
   ...
   vector<float>   *ADDjetPassIDLoose;
   vector<float>   *ADDjetPassIDTight;
   vector<float>   *ADDPUJetID;
   vector<float>   *ADDisPUJetID;
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("NCUGlobalTuples.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("NCUGlobalTuples.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("NCUGlobalTuples.root:/tree");
