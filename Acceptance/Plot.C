...
//histoname
TString histnameString("h_PtSubLead_Eff_HEEPID_Ele22_0");
TFile *fIn;
...
std::cout << filenameString[i] << "   " << " h_PtSubLead_Eff_HEEPID_Ele22_0 "  <<   " Integral : " << h_num[i]->Integral() << "   " << h_den[i]->Integral() << "  "<< std::endl;
...
histo->Draw("PE");
histo->SetName("h_PtSubLead_Eff_HEEPID_Ele22_0_h_PtSubLead");
...
//gr->Draw("AP");
//gr->SetName("h_PtSubLead_Eff_HEEPID_Ele22_0_h_PtSubLead");

TString FilePreName("AccEff_All");
TFile *fout= new TFile("AccEff_SETrigger_new_reco_BugR.root","UPDATE");
