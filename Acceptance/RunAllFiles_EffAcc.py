...
#outputfilepath='DYJetsToLL_M-10to50_new/'

if len(sys.argv) < 3 :
    print "insufficient options provided"
    print "proper usage "
    print "----------------------------------------------"
    print "python RunAllFiles_EffAcc.py path_of_hdfs Output_Path"
    print "----------------------------------------------"
...
#outputfilepath='DYJetsToLL_M-50_new/'
...
OutputMacro = open('run_low.C','w')
OutputMacro.write('void run_low(){ \n')
OutputMacro.write(' \n')
...
#os.system('/afs/hep.wisc.edu/cms/khurana/Monika/CMSSW_7_4_5/src/RKGlobalAnalyzer/Acceptance/test.sh')
