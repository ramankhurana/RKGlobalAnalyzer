...
#ifndef GenAceptance_h
#define GenAceptance_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   GenAceptance(TTree *tree=0);
   virtual ~GenAceptance();
...
#ifdef GenAceptance_cxx
GenAceptance::GenAceptance(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/hdfs/store/user/khurana/DYJetsToLL_M-50_TuneCUETP8M1_13TeV-amcatnloFXFX-pythia8/crab_DYJetsToLL_M-50_TuneCUETP8M1_13TeV-amcatnloFXFX-pythia8TreeMaker_MC50ns_1009/151009_133143/0001/NCUGlobalTuples_1.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/hdfs/store/user/khurana/DYJetsToLL_M-50_TuneCUETP8M1_13TeV-amcatnloFXFX-pythia8/crab_DYJetsToLL_M-50_TuneCUETP8M1_13TeV-amcatnloFXFX-pythia8TreeMaker_MC50ns_1009/151009_133143/0001/NCUGlobalTuples_1.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("/hdfs/store/user/khurana/DYJetsToLL_M-50_TuneCUETP8M1_13TeV-amcatnloFXFX-pythia8/crab_DYJetsToLL_M-50_TuneCUETP8M1_13TeV-amcatnloFXFX-pythia8TreeMaker_MC50ns_1009/151009_133143/0001/NCUGlobalTuples_1.root:/tree");
...
GenAceptance::~GenAceptance()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t GenAceptance::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t GenAceptance::LoadTree(Long64_t entry)
{
...
void GenAceptance::Init(TTree *tree)
{
...
void GenAceptance::Show(Long64_t entry)
{
...
Int_t GenAceptance::Cut(Long64_t entry)
{
